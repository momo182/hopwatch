...
<body>
	<div id="header">
		<div class="container wide">
			...
			<div id="menu">
				...
				<a class="buttonEnabled" href="http://godoc.org/github.com/momo182/hopwatch" target="_blank">About</a>
			</div>
		</div>
	</div>
	<div id="content">
	...
	<div id="footer">
		&copy; 2012-2022. <a href="http://github.com/momo182/hopwatch" target="_blank">hopwatch on github.com</a>
	</div>
</body>
</html>
`)
